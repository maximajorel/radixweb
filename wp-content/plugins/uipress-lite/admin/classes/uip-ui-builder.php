...
class uip_ui_builder extends uip_app
{
  ...
  public function add_ui_builder_to_menu()
  {
    ...
    add_options_page(__('UI Builder', 'uipress-lite'), 'uiBuilder', 'uip_manage_ui', uip_plugin_shortname . '-ui-builder', [$this, 'build_uibuilder_page']);
    return;
  }
  ...
  public function add_scripts_and_styles()
  {
    ...
    if (!uip_app_running) {
      ...
      //wp_enqueue_script('uip-vue', uip_plugin_url . 'assets/js/libs/vue-dev.js', [], uip_plugin_version);
    ...
    wp_enqueue_script('uip-sdaggable', uip_plugin_url . 'assets/js/libs/vue-draggable.js', ['uip-vue'], uip_plugin_version);
    wp_enqueue_script('uip-quill', uip_plugin_url . 'assets/js/libs/quill.min.js', ['uip-vue'], uip_plugin_version);
    wp_enqueue_script('uip-ace', uip_plugin_url . 'assets/js/libs/ace-editor.min.js', ['uip-vue'], uip_plugin_version);
    ...
    //Load styles
    //Load UIP icons
    wp_register_style('uip-quill', uip_plugin_url . 'assets/css/modules/uip-quill.css', [], uip_plugin_version);
    wp_enqueue_style('uip-quill');
  }
