...
//Import Vue modules
import * as uipAppDropdown from './modules/uip-dropdown.min.js?version=3092';
import * as uipAppMultiSelect from './modules/uip-multiselect.min.js?version=3092';
import * as uipAppUserMultiSelect from './modules/uip-user-role-multiselect.min.js?version=3092';
import * as uipAppAccordion from './modules/uip-accordion.min.js?version=3092';
import * as uipAppSwitchToggle from './modules/uip-switch-toggle.min.js?version=3092';
import * as uipAppTooltip from './modules/uip-tooltip.min.js?version=3092';
import * as uipAppChartLoading from './modules/uip-loading-chart.min.js?version=3092';
import * as uipAppOffcanvas from './modules/uip-offcanvas.min.js?version=3092';
import * as uipAppBlockContainer from './modules/uip-prod-block-container.min.js?version=3092';
import * as uipAppContentArea from './modules/uip-content-area.min.js?version=3092';
import * as uipAppChart from './modules/uip-chart.min.js?version=3092';
import * as uipAppModal from './modules/uip-modal.min.js?version=3092';
import * as uipAppSaveButton from './modules/uip-save-button.min.js?version=3092';

//Import main ui view
import * as uipMainView from './modules/uip-app-view.min.js?version=3092';
...
/**
 * Defines and create ui routes
 * @since 3.0.0
 */
const routes = [
  { path: '/', name: __('Admin home', 'uipress-lite'), component: uipMainView.moduleData(), query: { page: '1', search: '' } },
  {
    path: '/:pathMatch(.*)*',
    component: uipMainView.moduleData(),
  },
];

const uipAppRouter = VueRouter.createRouter({
...
//Import router
uipApp.use(uipAppRouter);
uipApp.provide('router', uipAppRouter);
