...
export class uipMediaLibrary {
  ...
  destroyLibrary(evt, container) {
    ...
    for (let key in this.events) {
      ...
      document.removeEventListener(eventItem.event, eventItem.func, true);
      // ...
    }
  ...
  createContainer() {
    let container =
      '\
	  <div class="uip-position-fixed uip-top-0 uip-left-0 uip-h-viewport uip-w-vw uip-background-black-wash uip-flex uip-flex-center uip-flex-middle uip-fade-in">\
  ...
  mountApp(selector) {
    ...
    const uipMediaApp = Vue.createApp(uipMediaArgs);
    ...
    uipMediaApp.component('drop-down', uipDropdown.moduleData());
