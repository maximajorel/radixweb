  ...
  return [
      ...
      optionsEnabled: [
        //Block options group
        {
          ...
          options: [
            ...
            { option: 'onClickCode', label: __('JavaScript on click', 'uipress-lite') },
          ],
        },
     ...
     */
    {
      ...
      optionsEnabled: [
        //Block options group
        {
          ...
          label: __('Block options', 'uipress-lite'),
          icon: 'check_box_outline_blank',
          options: [{ option: 'paragraph', label: __('Paragraph content', 'uipress-lite') }],
        },
        //Container options group
        {
          name: 'container',
     ...
     */
    {
      ...
      optionsEnabled: [
        //Block options group
        {
          ...
          label: __('Block options', 'uipress-lite'),
          icon: 'check_box_outline_blank',
          options: [{ option: 'imageSelect', uniqueKey: 'userImage', label: __('Image', 'uipress-lite') }],
        },
        //Container options group
        {
          name: 'container',
     ...
     */
    {
      ...
      optionsEnabled: [
        ...
        {
          name: 'contentAlign',
          label: __('Content align', 'uipress-lite'),
          icon: 'align_horizontal_left',
          styleType: 'style',
          options: uipress.returnFlexOptions(),
        },
        //Contentclass
        {
          name: 'contentStyle',
     ...
     */
    {
      ...
      optionsEnabled: [
        //Block options group
        {
          ...
          label: __('Block options', 'uipress-lite'),
          icon: 'check_box_outline_blank',
          options: [{ option: 'trueFalse', uniqueKey: 'prefersColorScheme', label: __('Let dark mode update based on OS theme?', 'uipress-lite') }],
        },
        //Container options group
        {
          name: 'container',
     ...
     */
    {
      ...
      optionsEnabled: [
        //Block options group
        {
          ...
          icon: 'check_box_outline_blank',
          options: [
            { option: 'textField', uniqueKey: 'videoURL', label: __('Video URL', 'uipress-lite') },
      ...
      optionsEnabled: [
        //Block options group
        {
          ...
          options: [
            ...
            { option: 'trueFalse', uniqueKey: 'inputRequired', label: __('Required field', 'uipress-lite') },
          ],
        },
        //Container options group
        {
