  ...
  return {
    ...
    data: function () {
      return {
        ...
        searchDisabled: this.block.settings.block.options.searchDisabled.value,
    ...
    watch: {
      'block.settings.block.options.searchDisabled.value': {
        handler(newValue, oldValue) {
          this.searchDisabled = newValue;
        },
        deep: true,
      },
      searchString: {
    ...
    template:
      '\
          <div :class="returnClasses()" class="uip-flex uip-flex-column uip-self-flex-start uip-max-w-100p uip-table-wrap" :id="block.uid">\
            <div class=" uip-margin-bottom-xs uip-flex uip-flex-between" v-if="!searchDisabled">\
                          ...
                          <td v-if="column.name == \'name\'" class="uip-padding-xxs uip-post-table-cell" :class="column.name">\
                            <div>\
                              <div class="uip-flex uip-flex-row uip-gap-xxs uip-flex-center" >\
                                ...
                                <div class="uip-text-xs uip-background-primary-wash uip-border-round uip-padding-xxxs uip-text-normal uip-post-type-label">{{item.type}}</div>\
