          ...
          options: [
            {
              ...
              label: __('Button submit text', 'uipress-lite'),
              value: {
            ...
            {
              option: 'submitAction',
              label: __('Submit action', 'uipress-lite'),
            },
            { option: 'trueFalse', uniqueKey: 'prePopulate', label: __('Prefill form data', 'uipress-lite') },
            { option: 'paragraph', uniqueKey: 'successMessage', label: __('Success message', 'uipress-lite'), value: __('Form sent successfully!', 'uipress-lite') },
          ],
        },
