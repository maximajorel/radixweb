export function moduleData() {
  return {
    ...
    template:
      '<div ref="container" v-if="responsiveHidden(block.responsive)" class="uip-position-relative uip-inline-flex" :class="{\'uip-border-dashed\' : uiTemplate.display == \'builder\'}"\
      @mouseenter="pushActiveHover(block, block.uid)" @mouseleave="removeActiveHover()" :id="\'container-\' + block.uid" >\
        <component is="style">\
          {{blockStyles}}\
        </component>\
